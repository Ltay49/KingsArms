...
function MainCourseSubmenu() {
  ...
  const mainCourses = [
    ...
    {
      name: "Gammon Steak with Egg & Chips",
      price: 10.5,
      kcal: 980,
      vegetarian: false,
      category: "Grill",
    ...
    {
      name: "Spicy Chicken Burger with Slaw",
      price: 10.0,
      kcal: 880,
      vegetarian: false,
      spicy: true,
    ...
    {
      name: "Plant-Based Burger with Avocado",
      price: 9.0,
      kcal: 790,
      vegetarian: true,
      category: "Burgers",
    ...
    {
      name: "Halloumi & Sweet Chilli Burger",
      price: 9.5,
      kcal: 820,
      vegetarian: true,
      spicy: true,
    ...
    {
      name: "Paneer Jalfrezi with Rice",
      price: 10.0,
      kcal: 870,
      vegetarian: true,
      spicy: true,
    ...
    {
      name: "Mushroom & Spinach Wellington",
      price: 9.5,
      kcal: 810,
      vegetarian: true,
      category: "Vegetarian",
    ...
    {
      name: "Mac & Cheese with Jalapeños",
      price: 8.5,
      kcal: 740,
      vegetarian: true,
      spicy: true,
    ...
    {
      name: "Beef Lasagne with Garlic Bread",
      price: 10.0,
      kcal: 870,
      vegetarian: false,
      category: "Pasta",
  ...
  const paginatedItems = mainCourses.slice(
    startIndex,
    ...
    <div className="maincourse-submenu">
      ...
      {Object.entries(groupedByCategory).map(([category, items]) => (
        <div key={category} className="submenu-section">
          <h4 className="submenuMc-subheading">{category}</h4>
